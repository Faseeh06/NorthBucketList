...
const steps = [
  {
    number: "01",
    title: "Choose",
    subtitle: "route & dates",
    description: "Pick a published itinerary or tell us your must-sees, pace, and budget—we suggest the best season and stopovers.",
  },
  {
    number: "02",
    title: "We",
    subtitle: "handle logistics",
    description: "Hotels, 4x4 or coaster transport, internal flights, permits, and a day-by-day brief—confirmed before you pay the balance.",
  },
  {
    number: "03",
    title: "Go",
    subtitle: "with support",
    description: "Your trip captain stays reachable on the road, adjusts for weather, and connects you with trusted guides in each valley.",
  },
];
...
export function HowItWorksSection() {
  ...
  return (
    <section
      id="how-it-works"
      ref={sectionRef}
      className="relative py-16 lg:py-20 how-it-works-bg text-foreground overflow-hidden"
    >
      ...
      <div className="relative z-10 w-full max-w-[min(100%,1760px)] mx-auto px-4 sm:px-5 lg:px-8">
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-20">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-muted-foreground/80">Plan.</span>
              <span className="block text-muted-foreground/40">Go.</span>
            </h2>
          </div>
          ...
          <div className={`relative h-[320px] lg:h-[640px] overflow-hidden transition-all duration-1000 delay-200 ${
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[oklch(0.96_0.02_200)] via-transparent to-transparent pointer-events-none" />
          </div>
        </div>
          ...
          {steps.map((step, index) => (
            <button
              ...
              className={`relative text-left p-8 lg:p-12 border transition-all duration-500 ${
                activeStep === index 
                  ? "bg-card border-foreground/25 shadow-sm" 
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                <span className={`text-4xl font-display transition-colors duration-300 ${
                  activeStep === index ? "text-primary" : "text-muted-foreground/50"
                }`}>
                  {step.number}
                </span>
              ...
              {/* Active indicator */}
              <div className={`absolute bottom-0 left-0 right-0 h-1 bg-primary transition-transform duration-500 origin-left ${
