...
const plans = [
  {
    name: "Weekend escape",
    description: "Naran, Shogran, or a quick Gilgit long weekend",
    price: { monthly: 0, annual: 0 },
    features: [
      "Shared coaster or private SUV options",
      "2–3 nights hand-picked stay",
      "Breakfast daily & route map",
      "WhatsApp support in-country",
      "Perfect for first-time north travelers",
    ],
    cta: "Request quote",
    highlight: false,
  },
  {
    name: "Hunza classic",
    description: "Our most-booked 7–9 night Karakoram loop",
    price: { monthly: 189000, annual: 165000 },
    features: [
      "Gilgit–Hunza–Khunjerab with altitude pacing",
      "Boutique hotels + one heritage guest night",
      "Private 4x4 and licensed guide each day",
      "Domestic flight blocks optional add-on",
      "Permits + Khunjerab day trip coordination",
      "Flexible rest afternoon if weather shifts",
    ],
    cta: "Hold dates",
    highlight: true,
  },
  {
    ...
    description: "Skardu, K2 approach treks, or private groups",
    price: { monthly: null, annual: null },
    features: [
      "Bespoke day-by-day routing",
      "Trek support & porter arrangements",
      "Sat phone on remote legs",
      "Film / corporate groups welcome",
      "Charter flights on request",
      "Dedicated trip captain 24/7",
      "Multi-family inclusive planning",
    ],
    cta: "Plan with us",
    highlight: false,
  },
      ...
      <div className="w-full max-w-[min(100%,1760px)] mx-auto px-4 sm:px-5 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 mb-12 lg:mb-16">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              Clarity
              <br />
              <span className="text-stroke">first.</span>
            </h2>
          </div>
                  ...
                  <div className="mb-8">
                    {plan.price.monthly !== null ? (
                      plan.price.monthly === 0 && plan.price.annual === 0 ? (
                        <span className="text-4xl font-display">From custom quotes</span>
                      ) : (
                      <div className="flex items-baseline gap-2">
                        <span className="text-5xl lg:text-6xl font-display">
                          Rs {isAnnual ? plan.price.annual : plan.price.monthly}
                        </span>
                    ...
                    {plan.price.monthly !== null && plan.price.monthly > 0 && (
                      <p className="text-xs text-muted-foreground mt-2 font-mono">
                        {isAnnual ? "shoulder & early season" : "peak window estimate"}
                      </p>
                    )}
                  </div>
        ...
        <div className={`mt-20 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 ${
          ...
          <div className="flex flex-wrap gap-6 text-sm text-muted-foreground">
            ...
            <span className="flex items-center gap-2">
              <Check className="w-4 h-4 text-primary" />
              ATOL-style transparency
            </span>
          </div>
          <a href="/discover#partners" className="text-sm underline underline-offset-4 hover:text-foreground transition-colors">
            See partner network
          </a>
        </div>
      </div>
